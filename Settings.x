...
#define BedtimeKey @"YTFlagsIAmNotGonnaSleep"
#define WatchingKey @"YTFlagsNoWatchingShelf"
#define AllowsBackgroundPlaybackKey @"YTFlagsEnableBackgroundPlayback"
#define EnablesPiPKey @"YTFlagsAllowsPiP"
#define DisablesShortsPiPKey @"YTFlagsTryToDisablesShortsPiP"
#define BlockUpgradeDialogsKey @"YTFlagsStopYouTubeForcingToUpgrade"
#define HideAreYouThereDialogKey @"YTFlagsHideAnnoyingDialog"
#define HideAdsBadgesKey @"YTFlagsHideAds"
#define HideYouTubeEduKey @"YTFlagsHideYouTubeEducations"
#define FixesSlowMiniPlayerKey @"YTFlagsFixesSlowPlayer"
#define DisablesNewMiniPlayerKey @"YTFlagsDisablesNewStyleMiniPlayer"
#define DisablesSnackBarKey @"YTFlagsDisablesAnnoyingYTHUD"
#define VideoAdsKey @"YTFlagsRemoveVideoAds"
